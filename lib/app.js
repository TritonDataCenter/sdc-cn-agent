...
App.prototype.startHeartbeater = function () {
    ...
    self.findValidCnapi(function (error, cnapiaddr) {
        if (error) {
            self.log.error({ error: error }, 'finding cnapi address');
            return;
        }
